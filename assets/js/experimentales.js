//trozos de códigos de youtube y otros repos

let API_LINK='https://api.github.com/users';

let search_btn = document.getElementsByTagName("button");

let search_term = document.getElementById("nombre");

var repoUl = document.getElementById("repo");


let urlRepos = "https://api.github.com/users/desafiolatam/repos";
